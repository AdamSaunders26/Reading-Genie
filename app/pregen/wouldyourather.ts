export const preGenWouldYouRathers = [
...

  {
    ...
    optionResponse: [
      ...
      "Amazing choice! You could travel anywhere in the world and never have a problem communicating. The ultimate traveler!",
    ],
  },
...

  {
    ...
    optionResponse: [
      ...
      "Imagine your teacher's response if you danced out of the classroom everytime. You might get in a little bit of trouble!",
    ],
  },

  {
    ...
    optionResponse: [
      "Imagine having a dinosaur as a pet! Walking it might be tough, but you’d have the coolest pet ever. I'd be worried I'd get eaten!",
      "A dragon could take you flying and be your personal heater in winter. Just remember to fireproof your house!",
    ],
  },
...

  {
    ...
    optionResponse: [
      ...
      "Color-changing horns would make you standout in any crowd! Halloween costumes just got an upgrade.",
    ],
  },

  {
    ...
    optionResponse: [
      "Saying everything on your mind would make for some interesting conversations! Secrets though might be hard to keep.",
...

  {
    ...
    optionResponse: [
      "Sleeping on marshmallows might be the comfiest sleep ever! Just hope you don’t melt them in your sleep.",
...

  {
    ...
    optionResponse: [
      ...
      "A swimsuit in Antarctica? Brrr! You’d have to do a lot of running around (from polar bears!) to stay warm.",
    ],
  },

  {
    ...
    optionResponse: [
      "A unicorn horn might catch of things. Imagine trying to put your school jumper on every morning.",
...

  {
    ...
    optionResponse: [
      ...
      "Having a kangaroo pouch could be handy for carrying your things, or even a small pet!",
    ],
  },
...

  {
    ...
    optionResponse: [
      ...
      "A tiny elephant could be the coolest little companion, fitting in your backpack. You'd be able to sneak her into school everyday. Imagine how much fun that would be at playtime.",
    ],
  },
...

  {
    ...
    optionResponse: [
      ...
      "With a watermelon-sized head, you'd have loads of brain space! Imagine getting in cars or on a train. You might leak some juice!",
    ],
  },
