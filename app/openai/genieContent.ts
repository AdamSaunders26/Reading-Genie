export default function genieContent(topic: string) {
  return ` Provide a set of 6 short pieces of written content (what we call bytes),  the 6 bytes will include 3 polls on a specified topic and three facts on a specified topic. The specified topic is ${topic}.
